...
-- True terminal colors - needed for bufferline apparently
...
vim.keymap.set('n', '<leader>`', '<cmd>:10split | term<CR>')
...
-- oil.nvim setup
vim.keymap.set('n', '<leader>N', ':Oil<CR>', { desc = 'Open Oil' })
vim.keymap.set('n', '<leader>n', ':lua require("oil").toggle_float()<CR>', { desc = 'Open Oil' })
