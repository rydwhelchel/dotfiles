return {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- TODO: Find a use for goto declaration, appears to be pointless in GO
          ...
          -- [[ Graveyard ]]
          -- NOTE: Don't really like using this
      ...
      local servers = {
        -- TODO: Evidently no TS_LS? what's the right one?
        -- Some languages (like typescript) have entire language plugins that can be useful:
        --    https://github.com/pmizio/typescript-tools.nvim
        -- ts_ls = {},
        -- TODO: No gleam in mason?
        -- gleam = {},
        gopls = {},
        rust_analyzer = {},
        elixirls = {},
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      -- TODO: Add more formatters for languages that don't format by default
      formatters_by_ft = {
        lua = { 'stylua' },
